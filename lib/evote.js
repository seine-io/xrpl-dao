...
var proposal = {
    id:"",
    title:"P#4 Acquire new boat",
    resolution:"The community will acquire a new electric and solar boat for the price of $$$.",
    minVoteDate:"",
    maxVoteDate:"",
...
function updateProposalStatus(status){
    ...
    if(status == ProposalStatus.ACCEPTED){
        proposalStatus2Div.innerHTML="go";
        proposalStatus2Div.style.backgroundColor="green";
    } else if(status == ProposalStatus.REFUSED){
        proposalStatus2Div.innerHTML="no";
        proposalStatus2Div.style.backgroundColor="red";
    } else {
